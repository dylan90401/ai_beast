...
show_kv "PORT_PORTAINER" "${PORT_PORTAINER:-9005}"
show_kv "PORT_SEARXNG" "${PORT_SEARXNG:-8088}"
show_kv "PORT_TRAEFIK_HTTP" "${PORT_TRAEFIK_HTTP:-80}"
show_kv "PORT_TRAEFIK_DASH" "${PORT_TRAEFIK_DASHBOARD:-8080}"
...
show_kv "Portainer" "http://${bind_addr}:${PORT_PORTAINER:-9005}"
show_kv "Traefik" "http://${bind_addr}:${PORT_TRAEFIK_DASHBOARD:-8080}"
show_kv "Langflow (docker)" "http://${bind_addr}:${PORT_LANGFLOW:-7860}"
show_kv "Flowise (docker)" "http://${bind_addr}:${PORT_FLOWISE:-3003}"
show_kv "Dify (docker)" "http://${bind_addr}:${PORT_DIFY:-3004}"
...
probe "searxng" "http://${bind_addr}:${PORT_SEARXNG:-8088}/"
probe "portainer" "http://${bind_addr}:${PORT_PORTAINER:-9005}/"
probe "traefik" "http://${bind_addr}:${PORT_TRAEFIK_DASHBOARD:-8080}/"
probe "dashboard" "http://${bind_addr}:${PORT_DASHBOARD:-8787}/"
