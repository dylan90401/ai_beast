...
from zenmapCore.SearchResult import SearchDB, SearchDir, SearchDummy
from zenmapCore.UmitConf import SearchConfig

from zenmapGUI.FileChoosers import DirectoryChooserDialog
from zenmapGUI.higwidgets.higboxes import (
    HIGHBox,
)
