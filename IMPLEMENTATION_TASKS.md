...
**Files:** `pyproject.toml:12`, `pyproject.toml:36`
**Issue:** Python version requirement mismatch

```toml
# Current:
[project]
requires-python = ">=3.12"  # Line 12

[tool.ruff]
target-version = "py311"    # Line 36 - INCONSISTENT
...
[tool.ruff]
target-version = "py312"    # Now consistent
```
...
**File:** `Makefile`
**Issue:** Uses `python` instead of `python3` (breaks on many systems)
